...
# --- Constants ---
API_TOKEN = os.getenv('API_TOKEN', '8177140674:AAFYZ7sbMiaw7ZtImk7T-N-mSB5drfPTjm4') # Replace with your actual token if not using .env
...
# --- MongoDB Setup ---
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://yesvashisht2005_db_user:yash2005@cluster0.zjdocvy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Replace YOUR_PASSWORD or use env var
